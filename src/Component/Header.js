        ...
        <>
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <div class="profile d-flex align-items-center">
                                <img
                                    ...
                                    class="rounded-circle me-2 me-sm-3 pr-img"
                                    style={{
                                        height: "66px",
                                        width: "66px",
                                        objectFit: "cover",
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        {userDetails?.user_type == "provider" ? "Provider" : "User"}
                                    </p>
                                </div>
                                <div class="dropdown ms-2 ms-md-3 ms-lg-5 action-btn">
                                    <button
                                        class=""
                                        type="button"
                    ...
                    <div class="modal-content">
                      ...
                      <img src={EditIcon}/>
                            ...
                            <div class="mt-4">
                                ...
                                <span class="plus-icon float-end">
                  <svg
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
                        ...
                        <g id="Icons">
                          ...
                          />
                            ...
                            <div class="btn_gred mt-4">
                                <button class="btn_admina ">save</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            >
                <ul className="mb-0 header-menu">
                    {
                        OPTIONS.map((opt, i) => (
                            <li className="m-0 my-4" onClick={() => navigate(opt.route)}>{opt.name}</li>
                        ))
                    }
            ...
            >
                ...
                <div class="text-center">
                    <img class="img-fluid logo" alt="" src={Logo2} width="145px"/>
                </div>
                <form class="login_margin" onSubmit={(e) => passwordSubmit(e)}>
                    <h3 class="mb-3 mb-md-3 page-title">Set New Password</h3>
