        ...
        <section className="main-page">
            ...
            <div className="main-inner">
                <div className="container">
                    ...
                    <Box>
                        <h3 style={{fontWeight: "600", marginBottom: "25px"}}>My Pages</h3>
                        <Box>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Box className="inner-gred page-Container-height">
                                        ...
                                        <Box className="border-gred">
                                            <TextArea rows={8} cols={6}  className="inner-gred" />
                                        </Box>
                                    </Box>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                    <Box className="inner-gred page-Container-height">
                                        <Box className="d-flex justify-content-between align-items-center">
                                            ...
                                            >
                                                <g id="add">
                                                    <g id="vuesax/outline/add"><g id="add_2">
                                                        <path
                                                            id="Vector"
                                                    ...
                                                    return (<>
                                                        <div className="group-input mt-2 p-15 clearfix">
                                                            <input
                                                                ...
                                                                value={webLinks[i]}
                                                                onChange={(e) => {
                                                                    const newValue = webLinks?.map((value, j) => {
                                                                        if (i == j) {
                    ...
                    <Box className="mt-5">
                        <h3 style={{fontWeight: "600", marginBottom: "25px"}}>My Services</h3>
                        <Box>
                            <Grid container spacing={2}>
                                {
                                                            ...
                                                            <IconButton sx={{padding: "0"}}
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        fill="#FFD8D8"/>
                                                                    <path d="M9.17 14.8299L14.83 9.16992"
                                                                          stroke="#FF0000" stroke-width="1.5"
                                                                          stroke-linecap="round"
                                                                          stroke-linejoin="round"/>
                                                                    <path d="M14.83 14.8299L9.17 9.16992"
                                                                          stroke="#FF0000" stroke-width="1.5"
                                                                          stroke-linecap="round"
                                                                          stroke-linejoin="round"/>
                                                                </svg>
                                                    ...
                                                    <Box className="d-flex gap-5 mt-3">
                                                        <Box>
                                                            <Box>
                                                                ...
                                                                <p style={{margin: "0"}}>{service.sessionPrice}</p>
                                                            </Box>
                                                            <Box className="mt-2">
                                                                <span className="grey-text">Additional Price</span>
                                                                <p style={{margin: "0"}}>{service.additionalPrice}</p>
                                                            </Box>
                                                        </Box>
                                                        <Box>
                                                            <Box>
                                                                <span className="grey-text">Participants</span>
                                                                <p style={{margin: "0"}}>{service.participants}</p>
                                                            </Box>
                                                            <Box className="mt-2">
                                                                    <span
                                                                        className="grey-text">Maximum Participants</span>
                                                                <p style={{margin: "0"}}>{service.maxParticipants}</p>
                                                            </Box>
                                                        </Box>
                                                    </Box>
                                                    <hr/>
