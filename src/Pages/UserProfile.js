...
const UserProfile = () => {
    ...
    const getImageUsingAi = async () => {
        ...
        await fetch(`https://api.openai.com/v1/images/generations`, {
            method: "POST", headers: {
                ...
                prompt: newservice?.join(", "), n: 1, size: "512x512",
            }),
        })
            .then((response) => response.json())
            .then((data) => {
    ...
    const serviceAdd = async () => {
        dispatch({
            type: loaderConstant.LOADER, payload: true,
        });
        const fdata = new FormData();
        fdata.append("user_id", userAuth._id);
        ...
        fdata.append("session_time", serviceForm.time);
        ...
        dispatch({
            type: loaderConstant.LOADER, payload: false,
        });
    };
      ...
      a0.075 0.075 0 0 1 0.0375 -0.06495190528 Z"
        ...
        <section class="main-page">
            ...
            {userDetails?.user_type == "user" ? (<>
                <div class="main-inner">
                    <div class="container">
                        <h1 class="d-inline-block">WELCOME ABOARD!</h1>
                        <p class="para mb-3 mb-lg-5">
                                    ...
                                    <div class="inner-gred">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                {userDetails?.mobile_number !== "" && userDetails?.mobile_number !== null ? (<>
                                <span class="me-2">
                                  {userDetails?.country_code}
                                            ...
                                            <li class="mb-0">
                                                ...
                                                {userDetails?.dob !== "" && userDetails?.dob !== null ? (
                                                    <span class="me-2">
                                {moment(userDetails?.dob?.split("T")[0]).format("D MMM, YYYY")}
                              </span>) : ("-")}
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <p class="note text-center mt-3 mt-md-5">
                ...
                <div class="main-inner">
                    <div class="container">
                        <h1 class="d-inline-block">WELCOME!</h1>
                        <p class="para mb-3 mb-lg-5">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                {userDetails?.website_link?.length > 0 && userDetails?.website_link[0] !== "" && (<>
                                    <div class="border-gred">
                                        <div class="inner-gred">
                                            <ul>
                                ...
                                <div class="border-gred">
                                    <div class="inner-gred pb-2">
                                        <h4 class="dec_title float-start mb-2">My Services</h4>
                                        <span
                                            class="float-end"
                                ...
                                <div class="round-image">
                                    <div class="first d-flex justify-content-center">
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[0]?.file_name ? userDetails?.provider_banner_images[0]?.file_name : "/images/1.jpg"}
                                                />
                                            </div>
                                        </div>
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[1]?.file_name ? userDetails?.provider_banner_images[1]?.file_name : "/images/2.png"}
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="first d-flex justify-content-center">
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[2]?.file_name ? userDetails?.provider_banner_images[2]?.file_name : "/images/3.jpg"}
                                                />
                                            </div>
                                        </div>
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[3]?.file_name ? userDetails?.provider_banner_images[3]?.file_name : "/images/4.jpg"}
                                                />
                                            </div>
                                        </div>
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[4]?.file_name ? userDetails?.provider_banner_images[4]?.file_name : "/images/5.jpg"}
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="first d-flex justify-content-center">
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[5]?.file_name ? userDetails?.provider_banner_images[5]?.file_name : "/images/6.jpg"}
                                                />
                                            </div>
                                        </div>
                                        <div class="polygon-imgae">
                                            <div class="p_image_shape">
                                                <img
                                                    src={userDetails?.provider_banner_images[6]?.file_name ? userDetails?.provider_banner_images[6]?.file_name : "/images/7.jpg"}
                                                />
                                            </div>
                                        </div>
                                    </div>
        ...
        >
            <button
                ...
                onClick={() => {
                    setmodelShow(false);
                    setserviceData(userDetails?.provider_services?.map((value) => {
                        return {
                    ...
                    setserviceIdList(userDetails?.provider_services?.map((value) => {
                        return value._id;
                    }));
                }}
            ...
            <form
                class="login_margin mt-2"
                onSubmit={(e) => {
                    e.preventDefault();
                    serviceAdd();
                }}
            >
                <h3 class="mb-3 mb-md-3 page-title">Add Service</h3>
                  ...
                  >
                    ...
                    Both
                            ...
                            {serviceForm.details !== "in_person" && (<>
                                <div class="group-input mt-3 p-15 clearfix">
                                    <input
                                        type="url"
                                        name=""
                        ...
                        <div className="detail_location mt-0">
                            ...
                            <div class="group-input mt-2 p-15 clearfix">
                                <input
                                    ...
                                    onChange={(e) => {
                                        setserviceForm({
                                            ...serviceForm, time: e.target.value,
                                        });
                                    }}
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 col-sm-6 mt-3">
                                    ...
                                    <div class="group-input mt-2 p-15 clearfix d-flex">
                                        <input
                                            type="text"
                                            name=""
                                            value="1 -"
                                            readOnly
                                            style={{
                                                width: "40px", padding: "15px 0 15px 20px", borderRadius: "3px 0 0 3px",
                                            }}
                                        />
                                        <input
                                            type="number"
                ...
                <div class="btn_gred mt-4">
                    ...
                    </a>) : (<button type="submit" class="btn_admina">
                        Save
                    </button>)}
                </div>
            </form>
