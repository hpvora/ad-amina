      ...
      <section className="main-page">
        ...
        <div className="main-inner">
          <div className="container">
                            ...
                            <div className="p-0 px-lg-5">
                              <div className="d-flex mt-4">
                                <div className="review_shape me-2 me-sm-3">
                                  <img
                                    src={`${ele?.user_details?.profile_picture}`}
                                  />
                                </div>
                                <div>
                                  <div className="d-flex align-items-center">
                                    <span>{ele?.user_details?.name}</span>
                              ...
                              <p className="mt-3 selected-item">
                                {ele?.review}
                              </p>
                            </div>
                          ))}
            ...
            <div>
              {userDetails?.find_user_service_details?.length > 0 && (
                <>
                  <Carousel
                        ...
                        <>
                          <div className="pro_carousel">
                            <div className="pro_carousel_content">
                              ...
                              <span className="pro_carousel_desc mt-1">
